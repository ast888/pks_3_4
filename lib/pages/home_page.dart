...
final List<Note> notes = <Note>[
  Note(
    ...
    description: '', // Add an empty string for the description
    price: '189600',
    ram: '8 ГБ',
    simCards: '1 (SIM+ESIM)',
    supports5G: 'Да',
  ...
  // Add the description parameter for the rest of the Note objects
  Note(
    id: '2',
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return ItemNote(notes: notes[index], cart: cart); // Передаем товар и корзину
        },
      ),
    );
  }
